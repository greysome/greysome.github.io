...
{% include figure.html src="tones1.png"
alt=""
figno=7
caption="After importing all .flacs" %}
...
{% include figure.html src="tones2.png"
alt=""
figno=8
caption="Notice how the first few chunks are all the same" %}
...
{% include figure.html src="tones3.png"
alt=""
figno=9
caption="The first 6 chunks match" %}
...
{% include figure.html src="tones4.png"
alt=""
figno=10
caption="I swear when I was solving it there wasn't such a long tail. But whatever" %}
...
{% include figure.html src="tones5.png"
alt=""
figno=11
caption="My awfully messy working in decoding the flag" %}
